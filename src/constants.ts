...
export const ITINERARY: DayItinerary[] = [
  ...
  },
  {
    ...
    "schedule": "08:30 辦理退房，京都車站集合出發（行李全放 KKday 專車行李廂）\r\n10:30-13:00 日本三景「天橋立」搭纜車登飛龍觀、享用特色午餐\r\n14:00-16:00「伊根舟屋」搭乘觀光遊船、體驗手拿蝦味先餵海鷗\r\n19:00 專車直達大阪心齋橋，辦理入住「心齋橋法拉格飯店」\r\n20:00 飯店 Lounge 享用免費研磨咖啡，回房好好休息",
  ...
  },
  {
    ...
    "date": "2/3（三）",
    "tagColor": "purple",
    "highlights": "大阪日潮選物＆親子零折返逛街日・宿心齋橋法拉格飯店\r\n大丸9F動漫 → PARCO空橋 → 南船場農林會館 → 堀江橘子街 → 飯店中繼放貨 → 道頓堀夜景",
    "schedule": "09:30 睡到自然醒，飯店 Lounge 享用免費研磨咖啡\r\n10:30【地點①】大丸心齋橋本館 9F（任天堂 OSAKA＋寶可夢中心 DX＋Jump Shop 剛開門免排隊）\r\n11:30【地點②】走 8F/9F 室內空橋直通 PARCO 1F~5F（HUMAN MADE、BAO BAO，免走地面吹風）\r\n12:15【地點③】PARCO B2 食堂街午餐 ＋【地點④】步行 3 分鐘回飯店第 1 次放戰利品、吹冷氣小憩\r\n13:35【地點⑤】南船場・大阪農林會館 3 樓（301室 Strato 試 AURALEE ＋ 303室 S.F.C 寬鬆 City Boy）\r\n14:30【地點⑥】西口靴下（頂級天然纖維手工襪）＋【地點⑦】ZABOU（RESOLUTE 710 神級牛仔褲）\r\n15:20【地點⑧】堀江 BIOTOP 4F 露天花園咖啡小憩 ＋【地點⑨】HW DOG 復古帽 ＋【地點⑩】SOPH\r\n17:00【地點⑪】DESCENDANT（西山徹日潮 KIDS 親子童裝首選）\r\n17:45【地點⑫】步行 8 分鐘回飯店第 2 次放戰利品、換輕便鞋子洗手小歇\r\n18:30【地點⑬】輕裝漫步 6 分鐘直達道頓堀拍固力果跑跑人，享用千房大阪燒／今井烏龍麵晚餐",
    "transport": "全程步行（法拉格飯店處於南船場、堀江與心齋橋核心樞紐，所有店點步行 1~8 分鐘內可達，免搭車折返）",
    "hotelId": "flag_shinsaibashi",
    "childHighlights": "大丸心齋橋 9F 巨大超夢/瑪利歐雕像\r\nBIOTOP 露天植物花園與甜點小憩\r\nDESCENDANT 日潮童裝親子穿搭\r\n道頓堀巨型立體招牌與固力果跑跑人",
    "food": "千房大阪燒（心齋橋店・海鮮/豬肉口味）\r\n道頓堀今井（豆皮烏龍麵・高湯極鮮）\r\nPARCO B2 霓虹食堂街各式熟食定食",
    "queueTips": "大丸本館 9F 任天堂專賣店週末假日人多，週三 10:30 剛開門直上 9 樓最順暢免排隊！\r\n南船場選物店普遍於 13:00 開門，早上先逛大丸本館時間銜接最完美。"
  },
  {
    "day": 5,
    "date": "2/4（四）",
...
export const SHOPPING_SPOTS: ShoppingSpot[] = [
  ...
  {
    id: 'soph_osaka',
    name: 'SOPH. OSAKA (F.C.R.B. / UE)',
    japaneseName: 'ソフ 大阪店',
    city: '大阪',
    zone: '堀江橘子街',
    brands: ['SOPHNET.', 'F.C.Real Bristol (F.C.R.B.)', 'uniform experiment'],
    styleCategory: '日系高機能街頭・足球潮流美學',
    floorInfo: '1F 獨棟極簡清水模門市',
    address: '大阪府大阪市西区南堀江1-20-9',
    walkingTimeFromHotel: '步行約 12 分鐘',
    howToFind: '橘子街中後段，極簡現代黑灰清水模建築，正門有醒目白字 SOPH. 標誌。',
    theShortyTip: '【日潮機能經典】F.C.R.B. 的防風防潑水機能外套與休閒短褲，剪裁俐落透氣，適合旅行與日常搭配，不易撞衫。',
    googleMapsUrl: 'https://www.google.com/maps/search/?api=1&query=SOPH.+OSAKA',
  ...
  },
  {
    ...
    styleCategory: '西山徹日常美式休閒・高品質家庭親子裝',
    floorInfo: '1F 街角門市',
    address: '大阪府大阪市西区南堀江1-19-2',
    walkingTimeFromHotel: '步行約 12 分鐘',
    howToFind: '南堀江安靜街角，經典藍色小鯨魚 Logo 門牌與木質大門。',
    theShortyTip: '【親子家庭穿搭首選】DESCENDANT 的版型舒適寬鬆且用料極厚實耐洗，重點是有推出極好看的「KIDS 童裝系列」，是日潮愛好者為 6 歲小孩購入日系親子裝的最佳地點！',
  ...
  },
  {
    ...
    name: '心齋橋 PARCO (1F-5F 流行潮流)',
    japaneseName: '心斎橋PARCO',
    city: '大阪',
    zone: '心齋橋大丸/PARCO',
    brands: ['HUMAN MADE', 'BAO BAO ISSEY MIYAKE', 'PORTER STAND', 'Kolor', 'Maison Kitsuné'],
    styleCategory: '人氣日潮設計師單品・室內空橋直通',
    floorInfo: 'PARCO 1F~5F（大丸本館 2F~10F 空橋直通）',
    address: '大阪府大阪市中央区心斎橋筋1-8-3',
    walkingTimeFromHotel: '步行約 3 分鐘',
    howToFind: '緊鄰大丸本館，兩棟大樓在 2F 至 10F 的每一層樓均有「室內空中連通走廊」，逛完大丸 9 樓可直接走室內空橋切換到 PARCO，免走回 1 樓吹風淋雨！',
    theShortyTip: '【省時動線】1F HUMAN MADE 經常有限定款 T 恤與配件；逛完順路搭電梯到 B2「心齋橋霓虹食堂街」吃午餐，省去找餐廳時間。',
