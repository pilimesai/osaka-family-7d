...
export const ITINERARY: DayItinerary[] = [
  ...
  },
  {
    ...
    "date": "2/1（一）",
    "tagColor": "orange",
    "highlights": "🚌 觀光包車一日遊 ＆ 京都嵐山 ＆ 鐵道博物館 ＆ 三條日潮專線（HUMAN MADE / TNF 紫標）→ 道頓堀蟹道樂晚餐 → 近鐵返回京都住宿\r\n上車：08:45 京都車站八條口觀光巴士停車場 → 嵐山 → 鐵道博物館 → HUMAN MADE 1928（藍瓶咖啡）＋TNF STANDARD（紫標神褲）→ 下車：18:30 道頓堀蟹道樂東店 → 近鐵直通 → 返回飯店",
    "schedule": "07:30 飯店享用早餐，打理出發\r\n🚌 08:45【上車地點】京都車站八條口觀光巴士停車場（Hotel Vischio Kyoto 步行約 3 分鐘）\r\n09:15-11:45 嵐山悠閒漫步（渡月橋、竹林小徑散策）\r\n12:00 嵐山享用道地午餐（京豆腐料理／京野菜天婦羅）\r\n13:30-15:45 京都鐵道博物館（扇形車庫看蒸汽火車、體驗模擬駕駛）\r\n16:15-17:15【地點①】HUMAN MADE 1928（1928洋樓古蹟、京都限定款、店內 Blue Bottle 藍瓶咖啡小憩）\r\n17:15-18:00【地點②】THE NORTH FACE STANDARD 京都店（步行3分鐘・入手日本限定 TNF 紫標工裝神褲與羽絨）\r\n🚌 18:30【下車地點】道頓堀蟹道樂 道頓堀東店（大阪市中央区道頓堀1-6-18）\r\n18:30-20:00 🦀 蟹道樂 道頓堀東店 豪華晚餐（正統松葉蟹全蟹料理）\r\n━━━ 🏠 返回飯店路線 ━━━\r\n20:10 步行約 6 分鐘至 大阪難波站（近鉄難波線）\r\n20:20 搭近鉄特急「近鉄大阪線/京都線直通」難波 → 京都（約 45 分鐘，¥680/人）\r\n21:05 抵達近鉄京都站，步行 5 分鐘至 Hotel Vischio Kyoto（八條口）\r\n21:15 返回飯店，享受 2 樓大浴場泡湯休息",
    "transport": "🚌 去程：觀光包車（08:45 上車 京都八條口觀光巴士停車場）\r\n🚌 包車途經：嵐山 → 鐵道博物館 → 三條商圈（HUMAN MADE / TNF）→ 18:30 下車道頓堀\r\n🚃 返程：道頓堀步行 6 分鐘至大阪難波站 → 近鉄京都線直通 → 京都站（約 45 分） → 步行 5 分回飯店",
    "hotelId": "vischio_kyoto",
    "childHighlights": "嵐山竹林漫步與渡月橋\r\n鐵道博物館蒸汽火車與模擬駕駛\r\nHUMAN MADE 1928 店內 Blue Bottle 藍瓶咖啡點心\r\n道頓堀蟹道樂豪華全蟹料理\r\n飯店 2 樓大浴場泡澡",
    "food": "嵐山豆腐料理／京野菜天婦羅\r\nBlue Bottle Coffee 藍瓶咖啡（HUMAN MADE 1928店）\r\n🦀 蟹道樂 道頓堀東店（晚餐・松葉蟹全蟹套餐・道頓堀標誌地景）",
    "queueTips": "🚌 08:45 準時抵達京都車站八條口觀光巴士停車場，切勿遲到！\r\nHUMAN MADE 1928 內建藍瓶咖啡，長輩小孩可坐著喝咖啡，大人輪流試穿 TNF 紫標！\r\n蟹道樂建議提前電話或網路訂位（+81-6-6211-8855），旺季熱門！\r\n返程近鉄買票可用 IC 卡（Suica/ICOCA）或現場自動售票機購買"
  },
  {
    "day": 3,
    "date": "2/2（二）",
