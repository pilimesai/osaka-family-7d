...
export const ITINERARY: DayItinerary[] = [
  ...
  },
  {
    ...
    "date": "2/3（三）",
    "tagColor": "purple",
    "highlights": "大阪日潮選物＆親子逛街日・宿心齋橋法拉格飯店\r\n大丸9F任天堂寶可夢 → 南船場農林會館選物 → 堀江橘子街散步 → 道頓堀夜景",
    "schedule": "09:30 睡到自然醒，飯店 Lounge 享用免費研磨咖啡\r\n10:30【動漫親子】步行 3 分鐘至大丸心齋橋本館 9F（任天堂 OSAKA＋寶可夢中心＋Jump Shop）\r\n12:30 大丸／PARCO B2 美食街悠閒午餐（或北極星蛋包飯）\r\n13:30【日潮選物】往北步行 5 分鐘至南船場「大阪農林會館」（Strato、S.F.C、西口靴下）\r\n15:00【潮流橘子街】漫步至堀江 Orange Street（BIOTOP 露天咖啡、THE H.W.DOG&CO. 帽飾、DESCENDANT）\r\n17:30 步行返回法拉格飯店放戰利品、小孩小憩\r\n19:00 道頓堀散步拍固力果跑跑人、享用美味串炸晚餐",
    "transport": "全程步行（法拉格飯店處於南船場、堀江與心齋橋核心樞紐，所有店點步行 3~12 分鐘內可達，免去轉車奔波）",
    "hotelId": "flag_shinsaibashi",
    "childHighlights": "大丸心齋橋 9F 巨大超夢/瑪利歐雕像\r\nBIOTOP 露天植物花園與甜點小憩\r\n道頓堀巨型立體招牌與固力果跑跑人",
    "food": "北極星蛋包飯（心齋橋本店・雞肉/蝦仁口味）\r\n元祖串炸達摩（炸蝦/蔬菜/起司）\r\n大丸 B2 美食街特色熟食",
    "queueTips": "大丸本館 9F 任天堂專賣店週末假日人多，週三中午前直上 9 樓最順暢免排隊！\r\n南船場選物店普遍於 13:00 開門，早上先逛大丸本館時間銜接最完美。"
  },
  {
    "day": 5,
    "date": "2/4（四）",
